...
public class Example4_2 {
    public static void main(String[] args) {
        ...
        System.out.println(zhubajie.weight+"的体重"+zhubajie.weight);
        System.out.println(zhubajie.head+"的头"+zhubajie.head);
        System.out.println(sunwukong.name+"的身高"+sunwukong.height);
        System.out.println(sunwukong.weight+"的体重"+sunwukong.weight);
        System.out.println(sunwukong.head+"的头"+sunwukong.head);
        ...
        System.out.println(sunwukong.name+"我现在的头"+sunwukong.head);
    }
}
